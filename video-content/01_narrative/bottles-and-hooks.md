# Narrative Bottles & Hooks

**Status:** LOCKED v1 (Phase 1 extraction)
**Derives from:** `evo_00/doc/IDENTITY.md` (Core Promise + triad pillar 3)
**Source:** evo_01 `PROMPT_MATRIX.md` + campaign PROMPTS.md files
**Global rule:** no bottle ever references price, dollars, or purchase terms.

---

## The Bottles (recurring story frames)

| Bottle | Visual anchor | The core hook |
| :--- | :--- | :--- |
...
## The POD Anchor (strongest line in the vault)

> **"Punters read a program; owners get the game plan."**
...
- *"Punters buy a program. Owners get the game plan. And the photo."*
- *"The race lasts two minutes. The feeling lasts all year. Become an Owner."*
- *"Real trainer updates. Real morning rituals. Become an Owner."*
- *"Don't just daydream about race day. Own it."*
- *"Stop buying souvenirs. Own the Experience."* ← adapted per founder ruling
  (was "Own the asset")

## Bumper / close-out

Every surface ends on the locked secondary anchor: **"Own the Experience."**
(one line, per IDENTITY.md §1). Brand end-card mark:
`DIGITAL-SYNDICATION, BY EVOLUTION STABLES`.

## Fictional-quote flag

Trainer/jockey/friend voice lines ("Get in here, co-owner", "I can't believe
she won") are fictional quoted characters. Every script carrying one carries
the flag. No real-stable endorsement implication.